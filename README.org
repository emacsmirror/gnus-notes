...
** Actions
   ...
   | =[F5]= | Insert org-link            | Insert org-link at point in buffer                                                  |
   | =[F6]= | Insert quick note          | Insert quick note at point in buffer                                                |
   | =[F7]= | Remove marked article(s)   | Remove current article or multiple marked articles (C-<space>) from the gnus-notes. |
   |        |                            | Gnus is not affected, this only affects the list.                                   |
   | =[F8]= | Display BBDB entries       | Display BBDB buffer.                                                                |
   | =[F9]= | Clear all                  | Start over. Clear ALL the articles on the list. Careful!                            |
   |--------+----------------------------+-------------------------------------------------------------------------------------|
