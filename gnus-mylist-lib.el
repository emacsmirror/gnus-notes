;;; gnus-mylist-lib.el --- Core definitions for gnus-mylist  -*- lexical-binding: t -*-
...
;; (require 'gnus-mylist)
;;
;; To start using gnus-mylist with helm, use the helm command 'helm-gnus-mylist'.
...
(provide 'gnus-mylist-lib)
;;; gnus-mylist-lib.el ends here
